...
本指南提供了全面的 **ChatGPT 中文版使用指南**，涵盖国内可用的 [**ChatGPT 镜像网站**](https://ai.lanjingai.org) 推荐和**GPT官网**使用教程，帮助您快速掌握 ChatGPT 的使用。
...
- [**ai.lanjingai.org**](https://ai.lanjingai.org/) - **ChatGPT 镜像网站**，运营近两年，支持 GPT-4、4o 以及 o1，提供 AI 文件、AI PPT、AI 助手、AI 插件功能、思维导图等。
